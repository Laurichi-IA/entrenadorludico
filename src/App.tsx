  ...
  return (
    <div className="min-h-screen bg-[#0D1B2A] text-[#f5f0e8] font-sans selection:bg-[#FF5C00] selection:text-white overflow-x-hidden">
      ...
      <nav className="sticky top-0 z-50 flex justify-between items-center px-6 py-4 backdrop-blur-md bg-[#0D1B2A]/80 border-b border-[#FF5C00]/20 shadow-lg transition-all" role="navigation" aria-label="Navegación principal">
        <a href="https://cisgein.com" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
        ...
        <a 
          ...
          aria-label="Inscribirse ahora en el formulario de Google"
        >
          ¡Inscribirme ahora!
        </a>
      </nav>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <a 
              ...
              aria-label="Reservar cupo para la certificación"
            >
              Quiero mi cupo <ChevronRight className="w-5 h-5" aria-hidden="true" />
            </a>
            <a 
              href="#programa" 
              ...
              aria-label="Ver el programa de la certificación"
            >
              Ver programa <Play className="w-4 h-4 fill-current" aria-hidden="true" />
            </a>
          </div>
      ...
      {/* SPEAKER / INSTRUCTOR */}
      <section id="instructor" className="relative py-32 overflow-hidden">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full max-w-6xl">
          <div className="absolute top-1/4 left-0 w-64 h-64 bg-[#FF5C00]/10 blur-[120px] rounded-full"></div>
          <div className="absolute bottom-1/4 right-0 w-64 h-64 bg-[#0A7E8C]/10 blur-[120px] rounded-full"></div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
          ...
          >
            ...
            <div className="w-full max-w-sm relative group">
              <div className="absolute -inset-6 bg-gradient-to-r from-[#FF5C00] to-[#0A7E8C] blur-3xl opacity-20 group-hover:opacity-40 transition-opacity duration-700"></div>
              
              <div className="relative aspect-[4/5] md:aspect-square rounded-[48px] bg-gradient-to-br from-[#FF5C00] via-[#FFD000] to-[#0A7E8C] p-[2px] shadow-2xl transform group-hover:scale-[1.02] transition-transform duration-500">
                <div className="w-full h-full rounded-[46px] bg-[#0B121D] overflow-hidden relative">
                  <img 
                    src={luigiImg} 
                    alt="Luigi Prado - Instructor Principal de LudoPrevención" 
                    width="400"
                    height="500"
                    loading="lazy"
                    ...
                    referrerPolicy="no-referrer"
                    onError={(e) => {
                      (e.target as HTMLImageElement).src = 'https://picsum.photos/seed/instructor/800/800';
                    }}
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#0B121D]/80 via-transparent to-transparent"></div>
                </div>
              </div>

              {/* Floating Badge - Moved outside overflow-hidden to be visible in front */}
              <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 z-20">
                <div className="bg-white text-[#0B121D] px-8 py-3 rounded-full font-black text-lg uppercase tracking-widest shadow-[0_10px_30px_rgba(0,0,0,0.5)] whitespace-nowrap border-4 border-[#FFD000] transform hover:scale-110 transition-transform duration-300">
                  Luigi Prado
                </div>
              </div>
            </div>
            ...
            <div className="max-w-3xl">
              <p className="text-[#FFD000] text-sm font-black tracking-[0.4em] uppercase mb-6">Instructor Principal</p>
              <h2 className="text-4xl md:text-6xl font-black mb-8 leading-[0.9] tracking-tight">
                El creador de <br/>
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF5C00] to-[#FFD000]">
                  LudoPrevención
                </span>
              </h2>
              
              <p className="text-[#f5f0e8]/80 text-xl leading-relaxed mb-10 font-medium">
                Ingeniero Ambiental con Maestría Internacional en SST. Auditor registrado por el MINTRA. 
                Implementador de Sistemas Integrados de Gestión bajo ISO 9001, 14001, 45001 y Ley 29783. 
                Creador de la metodología que está revolucionando la capacitación en SST en Latinoamérica.
              </p>

              <div className="flex flex-wrap gap-3 justify-center">
                {['ISO 45001 Expert', 'Auditor MINTRA', 'Metodología Lúdica', 'Ley 29783', 'Speaker Internacional'].map((cred, i) => (
                  <span key={i} className="bg-white/5 border border-white/10 text-white/90 px-6 py-2.5 rounded-2xl text-sm font-bold hover:bg-[#FF5C00]/20 hover:border-[#FF5C00]/40 transition-all duration-300">
                    {cred}
                  </span>
                ))}
              </div>
      ...
      <footer className="bg-[#050a11] py-20 px-6 border-t border-white/5">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-12 mb-16">
            <a href="https://cisgein.com" className="text-center md:text-left hover:opacity-80 transition-opacity">
            ...
            <div className="flex flex-wrap justify-center gap-10">
              ...
              <a href="https://www.instagram.com/cisgein" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-3 text-white/40 hover:text-[#FFD000] transition-all group" aria-label="Instagram de Cisgein">
                <div className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center group-hover:bg-[#FFD000]/10 group-hover:scale-110 transition-all">
                  <Instagram className="w-6 h-6" aria-hidden="true" />
                </div>
                <span className="text-xs font-black uppercase tracking-widest">@cisgein</span>
              </a>
              <a href="mailto:l.nunez@cisgein.com" className="flex flex-col items-center gap-3 text-white/40 hover:text-[#FFD000] transition-all group" aria-label="Enviar correo a Cisgein">
                <div className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center group-hover:bg-[#FFD000]/10 group-hover:scale-110 transition-all">
